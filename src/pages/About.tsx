            ...
            <main>
                <div className="w-full min-h-screen bg-gray-100">
                    ...
                    <div className="w-full bg-white py-2 px-4 flex flex-col items-center gap-4">
                        <button
                            onClick={() => window.open("https://docs.google.com/document/d/1qHcBDbdp8NY4xYRQj940k1yLnrU2k0MU/edit?usp=drivesdk&ouid=118310154413379562515&rtpof=true&sd=true", "_blank")}
